...
You should now be able to use python as well as several of the crucial libraries. You should be familiar with the kiva loan dataset and have a clear understanding of data science best practices.
...
## Advanced topics
Linear regression is one small part in a world of linear parametric models. Some additional advanced topics we recommend looking up are the following...
### Logistic regression
...
Both linear and logistic regression have a tendancy to overfit when there is a large number of features. Therefore it is important that we choose the features which have the most predictive power however, how do we choose these features? We can use our EDA to a certain extent but that only goes so far.
